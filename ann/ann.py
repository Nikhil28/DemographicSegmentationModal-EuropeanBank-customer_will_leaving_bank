...
# TypeError: unhashable type: 'slice' SOLUTION X.values[:, 1]
X.values[:, 1] = labelencoder_X_1.fit_transform(X.values[:, 1])
labelencoder_X_2 = LabelEncoder()
# TypeError: unhashable type: 'slice' SOLUTION X.values[:, 2]
...
# Feature Scaling (so our calculation will no go higher)
